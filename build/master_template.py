...
#### Temp empty hashed file list when testing new code ####
hashed_file_list = ""
###########################################################
...
post_cmd_to_execute = ", '; if [[ $? == 0 ]]; then tmsh load sys application template f5.service_discovery.tmpl;<ROUTE_ADD_CMD><BIGIQ_PWD_DELETE> bash /config/customConfig.sh; $(cp_logs); else $(cp_logs); exit 1; fi'"
