...
f5_networks_tag = 'release-4.4.0.0'
f5_cloud_libs_tag = 'v3.6.0'
f5_cloud_libs_azure_tag = 'v1.5.0'
f5_cloud_iapps_tag = 'v1.2.1'
f5_cloud_workers_tag = 'v1.0.0'
# Set BIG-IP versions to allow
default_big_ip_version = '13.0.03118'
allowed_big_ip_versions = ["13.1.0200", "13.0.03118", "12.1.22193", "latest"]
version_port_map = {"latest": {"Port": 8443}, "13.1.0200": {"Port": 8443}, "13.0.03118": {"Port": 8443}, "12.1.22193": {"Port": 443}, "443": {"Port": 443}}
route_cmd_array = {"latest": "route", "13.1.0200": "route", "13.0.03118": "route", "12.1.22193": "[concat('tmsh create sys management-route waagent_route network 168.63.129.16/32 gateway ', variables('mgmtRouteGw'), '; tmsh save sys config')]"}
network_mtu_array = {"12.1.22193": "[concat('tmsh modify net vlan internal mtu 1400; RUN_NETWORK=0; EXT_ROUTE=\"\"')]",
    "13.0.03118": "[concat('tmsh modify sys global-settings mgmt-dhcp disabled; tmsh save sys config; tmsh modify net vlan internal mtu 1400; RUN_NETWORK=1; EXT_ROUTE=\"\"')]",
...
offer_to_use = "[if(or(equals(parameters('bigIpVersion'), '12.1.22193'), equals(parameters('bigIpVersion'), '13.0.03118')), 'f5-big-ip-adc-preview', concat('f5-big-ip-', variables('imageNameToLower'), '-preview'))]"
license1_command = ''
license2_command = ''
big_iq_pwd_cmd = ''
bigiq_pwd_delete = ''
...
if template_name in ('standalone_1nic', 'standalone_2nic', 'standalone_3nic', 'standalone_n-nic', 'ha-avset', 'cluster_1nic', 'cluster_3nic', 'ltm_autoscale', 'waf_autoscale'):
    ...
    if template_name in ('ha-avset'):
        data['variables']['failoverCmdArray'] = { "12.1.22193": "echo \"Failover db variable not required.\"", "13.0.03118": "echo \"Failover db variable not required.\"", "13.1.0200": "tmsh modify sys db failover.selinuxallowscripts value enable", "latest": "tmsh modify sys db failover.selinuxallowscripts value enable" }
    if stack_type == 'new_stack':
